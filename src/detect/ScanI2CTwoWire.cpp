...
#endif
                // LP5562 shares I2C address 0x30 with MMC5983MA_ADDR, so it gets no SCAN_SIMPLE_CASE
                // here; the magnetometer's 0x2F product-ID probe below disambiguates the two devices.
#ifdef HAS_LP5814
