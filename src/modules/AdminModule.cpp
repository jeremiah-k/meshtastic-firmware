...
NodeNum AdminModule::getEditTransactionOriginalDestForSession(uint32_t sessionId) const
{
    return sessionId != 0 && editTransactionLocalOwner == sessionId ? getEditTransactionOriginalDest() : 0;
}
