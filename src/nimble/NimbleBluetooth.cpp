...
static_assert(ConnectionParamsUpdateController::NO_CONNECTION == BLE_HS_CONN_HANDLE_NONE);
} // namespace
...
class BluetoothPhoneAPI : public PhoneAPI, public concurrency::OSThread
{
  ...
  public:
    ...
    ConnectionParamsUpdateController connectionParamsController;
  ...
  protected:
    ...
    virtual void onConfigStart() override
    {
        ...
        requestConnectionParams(ConnectionParamsMode::HIGH_THROUGHPUT);
    }
    ...
    virtual void onConfigComplete() override
    {
        ...
        requestConnectionParams(ConnectionParamsMode::LOW_POWER);
    }
    ...
    void requestConnectionParams(ConnectionParamsMode mode)
    {
